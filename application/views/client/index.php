...
<div class="for-photo inform">
    <div class="center">
        ...
        <p>ООО" ИмобиленИнвест " - быстроразвивающаяся инжиниринговая инвестиционная компания, работающая на рынках Республики Беларусь и стран  ближнего и дальнего зарубежья.</p>
    </div>
</div>
    ...
    <div class="news">
        <div class="main-news">
            <div class="hidden active">
                ...
                <h2>ООО «ИмобиленИнвест»</h2>
                <p>Динамичная, быстро развивающаяся компания, специализирующаяся на привлечении инвестиций, проектировании и строительстве объектов различного назначения и предоставлении инжиниринговых услуг в сфере строительства. 
                </p>
                <p>ООО" ИмобиленИнвест "  осуществляет функции управляющей компании. </p>
                <p>ООО «ИмобиленИнвест» – одна из специализированных фирм, оказывающих инжиниринговые услуги в сроительстве. </p>
                <p>За время своего существования, компания приобрела заслуженное доверие зарубежных и отечественных компаний, благодаря высокопрофессиональному менеджменту  и использованию новейших передовых технологий в области строительного проектирования. </p>
                <p>Представляя интересы заказчика на всех этапах работы – от подбора участка, проектирования и до ввода объекта в эксплуатацию. ООО «ИмобиленИнвест» стремится минимизировать стоимость работ при максимальной эффективности, используя прогрессивные разработки научно-исследовательских институтов и эффективное взаимодействие с организациями-подрядчиками и поставщиками оборудования.</p>
                <p>Внедрение новейших инноваций при проектировании и строительстве позволяют ООО «ИмобиленИнвест» работать с  объектами любого уровня сложности.</p>
                <p>Строительный инжиниринг охватывает все фазы реализации инвестиционно-строительных процессов: проектирование, строительство, эксплуатацию объектов, а так же включает в себя проектные работы, авторский и технический надзор. Наша компания предоставляет полный комплекс работ и услуг по сопровождению всех этапов инвестиционно-строительных проектов, в том числе маркетинговые исследования, получение участков под строительство, проведение тендеров, оптимизацию финансовых потоков.
                </p>
                <p>Для реализации названных задач наша компания готова предложить вам перечень мероприятий осуществляемых на различных этапах инвестиционно-строительного проекта:</p>
                <ul>
                    <li>Инвестиционный замысел</li>
                    <li>Выбор и подбор участка</li>
                    <li>Маркетинговые исследования,  бизнес – планирование,  разработка концепции</li>
                    <li>Проектно-изыскательские работы</li>
                    <li>Получение инвестиций</li>
                    <li>Строительство объектов</li>
                    <li>Продажи объектов</li>
                </ul>
                <p>Мы видим свою цель работы в возведении зданий и сооружений, отвечающих эстетике ХХI века, в продвижении на отечественный рынок самых передовых технологий и современных строительных материалов. ООО «ИмобиленИнвест» стремится идти в ногу со временем, демонстрируя высокотехнологичный подход к строительному бизнесу. Мы всегда готовы искать индивидуальные формы сотрудничества с каждым клиентом и предоставить ему оптимальное соотношение стоимости и качества услуг.
                </p>
                <p>На данный момент ведущим проектом компании является <a href="/фок-рафиева-белецкого-минск">строительство физкультурно-оздоровительного комплекса</a>.</p>
            </div>						
            <div class="null"></div>
        </div>
    </div>
